...
class ActivityModel extends Model
{
     ...
     * @return array
     */
    public function getActivityList(array $map = [], $field = '*', array $search = [],$page_now=1, $page_size = 0)
    {
        $row = [];
        if($page_size<1){
     ...
     * @return boolean
     */
    public function checkActivity($activity_id = 0,$store_id= 0)
    {
        if(empty($activity_id) || empty($store_id)) return false;
        $map =[
