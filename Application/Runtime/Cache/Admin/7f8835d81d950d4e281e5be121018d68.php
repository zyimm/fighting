...
<div class="pbadgeding table-responsive">
	<?php echo crumbs(35,'列表详细');?>
	<hr />
	<div class="alert margin-bottom"><a href="/Admin/Badge/add" class="button border-main icon-plus-square">&nbsp;新增</a></div>
	<table class="table table-bordered table-hover table-striped">
		<tbody> 
			...
			<?php if(is_array($badge_list)): $i = 0; $__LIST__ = $badge_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$badge): $mod = ($i % 2 );++$i;?><tr>
				...
				<?php if($badge["badge_type"] == 2 ): ?>评论徽章<?php endif; ?>	
				<?php if($badge["badge_type"] == 3): ?>赛事徽章<?php endif; ?>	
				<?php if($badge["badge_type"] == 4): ?>活动徽章<?php endif; ?>
				</td>
				<td>
				...
				<td>
					<a href="/Admin/Badge/edit?badge_id=<?php echo ($badge["badge_id"]); ?>" class="button bg-blue button-little">编辑</a>
