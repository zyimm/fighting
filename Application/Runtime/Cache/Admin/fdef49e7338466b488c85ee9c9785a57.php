...
<div class="padding table-responsive">
	...
	<hr />
	<div class="alert"><a href="/Admin/Role/add" class="button bg-main icon-plus-square">&nbsp;新增角色</a></div>
	<table class="table table-hover table-striped"> 
		...
		<?php if(is_array($role_list)): $i = 0; $__LIST__ = $role_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rl): $mod = ($i % 2 );++$i;?><tr>
			...
			<?php else: ?>
				<a href="/Admin/Role/edit?role_id=<?php echo ($rl["id"]); ?>" class="button bg-blue button-little">修改</a>
				<a href="/Admin/Role/" class="button bg-dot  button-little">禁用</a>
				<a href="/Admin/Role/roleRule?role_id=<?php echo ($rl["id"]); ?>" class="button bg-green  button-little">权限修改</a><?php endif; ?>	
			</td>
