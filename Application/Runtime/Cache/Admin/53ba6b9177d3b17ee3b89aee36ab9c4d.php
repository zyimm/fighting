...
<body>
	<div class="layout admin-top">
		...
		<div class="admin-top-memu float-right "> 
			<ul class="nav nav-menu nav-inline nav-navicon"> 
				<li class='float-right'><a href="/admin/login/loginout.html" ><i class="icon-sign-out padding-small-right"></i><span>退出</span></a></li>
				<li class='float-right'><a href="javascript:clearCache('/admin/index/clearCache.html');" ><i class="icon-trash-o padding-small-right"></i><span>清空缓存</span></a></li>
	...
	<div class="layout"> 
		...
		<div class="admin-main"> 
			<iframe  id='MainIframe' name="MainIframe" class="iframe" src="/admin/index/welcome.html" style="width: 100%;height: 100%;border: 0;"></iframe>
		</div>
	...
	<script type="text/javascript">  
		...
		var clearCache=function(url){
			...
			layer.msg('清空缓存成功啦!√',{icon:1,shade: [0.8, '#393D49'],time:2000});
		};
		//
