...
<div class="padding table-responsive">
	<?php echo crumbs(11,'列表详细');?>
	<hr />
	<div class="alert"><a href="/Admin/Role/addAdmin" class="button bg-main icon-plus-square">&nbsp;新增平台管理员</a></div>
	<table class="table table-hover table-striped"> 
		...
		<?php if(is_array($admin_list)): $i = 0; $__LIST__ = $admin_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$al): $mod = ($i % 2 );++$i;?><tr>
			...
			<?php else: ?>
				...
				<a href="/Admin/Role/editAdmin?admin_id=<?php echo ($al["id"]); ?>" class="button bg-blue button-little">修改</a>
				<a href="/Admin/Role/" class="button bg-dot  button-little">禁用</a><?php endif; ?>			
