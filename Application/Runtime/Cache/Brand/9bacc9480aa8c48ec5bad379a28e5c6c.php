	...
	<div> 
		<table class="table table-hover table-striped"> 
			...
			<?php if(is_array($store_list)): $i = 0; $__LIST__ = $store_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sl): $mod = ($i % 2 );++$i;?><tr> 
				...
				<td><img src="/Brand/Store/getStoreCode?store_id=<?php echo ($sl["store_id"]); ?>" alt="" width=60 height=60  onclick="showImage('/Brand/Store/getStoreCode?store_id=<?php echo ($sl["store_id"]); ?>')" style='cursor:pointer' /></td>
				<td> 
				...
				<td> 
					<a href="/Brand/Store/edit?store_id=<?php echo ($sl["store_id"]); ?>" class='button border-blue button-little'>修改</a>
					<a href="/Brand/Store/del?store_id=<?php echo ($sl["store_id"]); ?>" class='button border-dot button-little '>删除</a>
				</td>
