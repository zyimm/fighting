	...
	<table class="table table-bordered table-hover table-striped radius ">
		<tbody>
			...
			<?php if(is_array($students_list)): $i = 0; $__LIST__ = $students_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sl): $mod = ($i % 2 );++$i;?><tr>
				...
				<td rowspan="1">
					<a class="button border-blue button-little" href="/Store/Students/edit?student_id=<?php echo ($sl["student_id"]); ?>">编辑</a> 
					<a class="button border-red button-little " href="javascript:;" onclick="itemDel(<?php echo ($sl["student_id"]); ?>,'/Store/Students/del')">删除</a>
				</td>
