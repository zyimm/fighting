...
<div class="padding table-responsive">
	...
	<hr />
	<div class="alert margin-bottom"><a href="/Store/Article/add" class="button border-main icon-plus-square">&nbsp;新增</a></div>
	<table class="table table-bordered table-hover table-striped">
		<tbody> 
			...
			<?php if(is_array($article_list)): $i = 0; $__LIST__ = $article_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$article): $mod = ($i % 2 );++$i;?><tr>
				...
				<td>
					<a href="/Store/Article/edit?article_id=<?php echo ($article["article_id"]); ?>" class="button bg-blue button-little">编辑</a>
					<a href="javascript:void(0)" onclick="itemDel(<?php echo ($article["article_id"]); ?>,'/Store/Article/del');" class="button bg-dot button-little">删除</a>
				</td>
