...
<div class="padding table-responsive">
	<?php echo crumbs(13,'列表详细','store_menu');?>
	<hr />
	<div class="alert margin-bottom"><a href="/Store/Ad/add" class="button border-main icon-plus-square">&nbsp;新增</a></div>
	<table class="table table-bordered table-hover table-striped">
		<tbody> 
			...
			<?php if(is_array($ad_list)): $i = 0; $__LIST__ = $ad_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ad): $mod = ($i % 2 );++$i;?><tr>
				...
				<td>
					<a href="/Store/Ad/edit?ad_id=<?php echo ($ad["ad_id"]); ?>" class="button bg-blue button-little">编辑</a>
					<a href="javascript:void(0)" onclick="itemDel(<?php echo ($ad["ad_id"]); ?>,'/Store/Ad/del');" class="button bg-dot button-little">删除</a>
