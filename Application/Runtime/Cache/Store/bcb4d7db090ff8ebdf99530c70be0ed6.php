	...
	<div class="layout admin-top">
		...
		<div class="admin-logo float-left padding">
			<a class="text-large " target="_blank" href="javascript:void(0)">
				...
				<span class="cmf" style="color: #3fa9f5; font-size:16px;"><b><?php echo get_store_name($store_id);?></span></b></span>
		...
		<div class="admin-top-memu float-right "> 
			<ul class="nav nav-menu nav-inline nav-navicon"> 
				...
				<li class='float-right'><a href="javascript:void(0)" ><i class="icon-user padding-small-right"></i><span><?php echo ($store_admin_info["user_name"]); ?>[<?php echo ($store_admin_info["role_name"]); ?>]</span></a></li>
			</ul>
		</div>
	</div>
	<div class="layout"> 
		...
		<div class="admin-main"> 
			<iframe  id='MainIframe' name="MainIframe" class="iframe" src="/Store/Index/welcome.html" style="width: 100%;height: 100%;border: 0;"></iframe>
		</div>
